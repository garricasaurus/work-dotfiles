...
static const char *volup_sm[]       = { "smart-status", "volume", "pamixer --allow-boost --increase 1", NULL };
static const char *voldown_sm[]     = { "smart-status", "volume", "pamixer --allow-boost --decrease 1", NULL };
static const char *volup_lg[]       = { "smart-status", "volume", "pamixer --allow-boost --increase 10", NULL };
static const char *voldown_lg[]     = { "smart-status", "volume", "pamixer --allow-boost --decrease 10", NULL };
static const char *volmute[]        = { "smart-status", "volume", "pamixer --toggle-mute", NULL };
static const char *brup_sm[]        = { "smart-status", "brightness", "pkexec brillo -A 1", NULL };
static const char *brdown_sm[]      = { "smart-status", "brightness", "pkexec brillo -U 1", NULL };
static const char *brup_lg[]        = { "smart-status", "brightness", "pkexec brillo -A 10", NULL };
static const char *brdown_lg[]      = { "smart-status", "brightness", "pkexec brillo -U 10", NULL };
